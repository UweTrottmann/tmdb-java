...
public class TestData {
    ...
    public static TmdbDate testPersonChangesStartDate;
    public static TmdbDate testPersonChangesEndDate;
    ...
    public static TmdbDate testMovieChangesStartDate;
    public static TmdbDate testMovieChangesEndDate;
    ...
    public static TmdbDate testTvShowChangesStartDate;
    public static TmdbDate testTvShowChangesEndDate;

    public static final TvSeason testTvSeason = new TvSeason();
    public static TmdbDate testTvSeasonChangesStartDate;
    public static TmdbDate testTvSeasonChangesEndDate;

    public static final TvEpisode testTvEpisode = new TvEpisode();
    public static TmdbDate testTvEpisodeChangesStartDate;
    public static TmdbDate testTvEpisodeChangesEndDate;
    ...
    private static void initializeTestingIntegrityData() {
        testCompany.id = 5;
        ...
        testPerson.birthday = new TmdbDate("1972-08-15");
        testPerson.gender = 2;
        testPerson.id = 880;
        ...
        testPersonChangesStartDate = new TmdbDate("2016-12-16");
        testPersonChangesEndDate = new TmdbDate("2016-12-28");
        ...
        testMovie.release_date = new TmdbDate("2012-04-25");
        testMovie.original_language = new Language("en");
        ...
        testMovieChangesStartDate = new TmdbDate("2017-3-24");
        testMovieChangesEndDate = new TmdbDate("2017-4-2");
        ...
        testTvShow.first_air_date = new TmdbDate("1989-12-17");
        testTvShow.id = 456;
        testTvShow.homepage = "http://www.thesimpsons.com/";
        testTvShow.original_language = new Language("en");
        ...
        testTvShowChangesStartDate = new TmdbDate("2017-2-2");
        testTvShowChangesEndDate = new TmdbDate("2017-2-4");
        ...
        testTvSeason.air_date = new TmdbDate("1989-12-17");
        ...
        testTvSeasonChangesStartDate = new TmdbDate("2015-10-10");
        testTvSeasonChangesEndDate = new TmdbDate("2015-10-24");
        ...
        testTvEpisode.air_date = new TmdbDate("1989-12-17");
        ...
        testTvEpisodeChangesStartDate = new TmdbDate("2017-2-2");
        testTvEpisodeChangesEndDate = new TmdbDate("2017-2-4");
        ...
        testReview.language = new Language("en");
