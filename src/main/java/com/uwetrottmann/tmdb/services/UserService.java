...
public final class UserService extends TmdbApiService {
    ...
    public static final class CalendarShowsBuilder extends TmdbApiBuilder<List<CalendarDate>> {
    ...
    public static final class WatchingBuilder extends TmdbApiBuilder<ActivityItemBase> {
    ...
    public static final class WatchedBuilder extends TmdbApiBuilder<List<ActivityItem>> {
    ...
    public static final class WatchedEpisodesBuilder extends TmdbApiBuilder<List<ActivityItem>> {
    ...
    public static final class WatchedMoviesBuilder extends TmdbApiBuilder<List<ActivityItem>> {
    ...
    public static final class WatchlistEpisodesBuilder extends TmdbApiBuilder<List<TvShow>> {
    ...
    public static final class WatchlistMoviesBuilder extends TmdbApiBuilder<List<Movie>> {
    ...
    public static final class WatchlistShowsBuilder extends TmdbApiBuilder<List<TvShow>> {
    ...
    public static final class ProfileBuilder extends TmdbApiBuilder<UserProfile> {
    ...
    public static final class FriendsBuilder extends TmdbApiBuilder<List<UserProfile>> {
    ...
    public static final class LibraryMoviesAllBuilder extends TmdbApiBuilder<List<Movie>> {
    ...
    public static final class LibraryMoviesCollectionBuilder extends TmdbApiBuilder<List<Movie>> {
    ...
    public static final class LibraryMoviesHatedBuilder extends TmdbApiBuilder<List<Movie>> {
    ...
    public static final class LibraryMoviesLovedBuilder extends TmdbApiBuilder<List<Movie>> {
    ...
    public static final class LibraryMoviesWatchedBuilder extends TmdbApiBuilder<List<Movie>> {
    ...
    public static final class LibraryShowsAllBuilder extends TmdbApiBuilder<List<TvShow>> {
    ...
    public static final class LibraryShowsCollectionBuilder extends TmdbApiBuilder<List<TvShow>> {
    ...
    public static final class LibraryShowsHatedBuilder extends TmdbApiBuilder<List<TvShow>> {
    ...
    public static final class LibraryShowsLovedBuilder extends TmdbApiBuilder<List<TvShow>> {
    ...
    public static final class LibraryShowsWatchedBuilder extends TmdbApiBuilder<List<TvShow>> {
    ...
    public static final class ListsBuilder extends
            TmdbApiBuilder<List<com.uwetrottmann.tmdb.entities.List>> {
        private static final String URI = "/user/lists.json/" + FIELD_API_KEY + "/"
                + FIELD_USERNAME;

        private ListsBuilder(UserService service) {
            super(service, new TypeToken<List<com.uwetrottmann.tmdb.entities.List>>() {
            }, URI);
        }
