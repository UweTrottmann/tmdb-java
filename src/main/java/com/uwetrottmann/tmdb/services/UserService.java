...
public final class UserService extends TraktApiService {
    ...
    public static final class ListBuilder extends TraktApiBuilder<com.uwetrottmann.tmdb.entities.List> {
        ...
        private ListBuilder(UserService service) {
            super(service, new TypeToken<com.uwetrottmann.tmdb.entities.List>() {}, URI);
        }
    ...
    public static final class ListsBuilder extends TraktApiBuilder<List<com.uwetrottmann.tmdb.entities.List>> {
        private static final String URI = "/user/lists.json/" + FIELD_API_KEY + "/" + FIELD_USERNAME;

        private ListsBuilder(UserService service) {
            super(service, new TypeToken<List<com.uwetrottmann.tmdb.entities.List>>() {}, URI);
        }
