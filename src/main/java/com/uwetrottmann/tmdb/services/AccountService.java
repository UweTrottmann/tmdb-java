...
public class AccountService extends TraktApiService {
     ...
     * @param email E-mail to register, a welcome email will automatically be
     *            sent here.
    ...
    public static final class CreateBuilder extends TmdbApiBuilder<Response> {
    ...
    public static final class TestBuilder extends TmdbApiBuilder<Response> {
