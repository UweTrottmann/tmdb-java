...
public interface AccountService {
    ...
    Observable<MovieResultsPage> favoriteMovies(
            @Path("account_id") Integer accountId,
    ...
    Observable<TvShowResultsPage> favoriteTvShows(
            @Path("account_id") Integer accountId,
            @Query("language") String language,
            @Query("sort_by") SortBy sortBy,
            @Query("page") Integer page
    ...
    Observable<MovieResultsPage> ratedMovies(
            @Path("account_id") Integer accountId,
            @Query("language") String language,
            @Query("sort_by") SortBy sortBy,
            @Query("page") Integer page
    ...
    Observable<TvShowResultsPage> ratedTvShows(
            @Path("account_id") Integer accountId,
            @Query("language") String language,
            @Query("sort_by") SortBy sortBy,
            @Query("page") Integer page
    ...
    Observable<TvEpisodeResultsPage> ratedTvShowEpisodes(
            @Path("account_id") Integer accountId,
            @Query("language") String language,
            @Query("sort_by") SortBy sortBy,
            @Query("page") Integer page
    ...
    Observable<MovieResultsPage> watchlistMovies(
            @Path("account_id") Integer accountId,
            @Query("language") String language,
            @Query("sort_by") SortBy sortBy,
            @Query("page") Integer page
    ...
    Observable<TvShowResultsPage> watchlistTvShows(
            @Path("account_id") Integer accountId,
            @Query("language") String language,
            @Query("sort_by") SortBy sortBy,
            @Query("page") Integer page
